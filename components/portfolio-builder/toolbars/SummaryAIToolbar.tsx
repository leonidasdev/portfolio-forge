  ...
  return (
    <div className="mb-4 p-4 bg-gradient-to-r from-green-50 to-teal-50 border border-green-200 rounded-lg">
      <div className="space-y-3">
        <div>
          <span className="text-sm font-medium text-gray-700">AI Summary Generator</span>
        ...
        <p className="text-xs text-gray-500">
          Tip: &quot;From my data&quot; uses your saved certifications, experience, and skills.
          &quot;From sections&quot; uses current portfolio section content.
        </p>
      </div>
