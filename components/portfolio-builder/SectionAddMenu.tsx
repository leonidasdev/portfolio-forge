...
export function SectionAddMenu({ portfolioId, onSectionAdded }: SectionAddMenuProps) {
  ...
  const sectionTypes = [
    { type: 'about', label: 'About', description: 'A brief introduction about yourself' },
    { type: 'skills', label: 'Skills', description: 'Your technical and soft skills' },
    { type: 'experience', label: 'Work Experience', description: 'Your employment history' },
    { type: 'projects', label: 'Projects', description: 'Your personal and professional projects' },
    {
      type: 'certifications',
      label: 'Certifications',
      description: 'Your certifications and credentials',
    },
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium text-gray-900">Add Section</h3>
      ...
      {isAdding && <div className="text-sm text-gray-600 text-center">Adding section...</div>}
    </div>
  )
}
